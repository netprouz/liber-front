...
import { CardBox, CustomBox, Flex, ImageBox, Label, CardTitle } from './styles/sub.style'
    ...
    return (
        <>
            <CardBox bgColor="#ff7f4d" minHeight={176}>
                <CardTitle>Узингиз севган булимга<br />
                    обуна бўлинг</CardTitle>
                <ImageBox topBottom="top">
                    <Image src={WavePng} alt="wave" />
                    <Image src={GirlPng} alt="girl" />
                </ImageBox>
            </CardBox>
            ...
            <Paper sx={{ padding: "32px 32px 122px 32px", marginTop: "24px" }}>
                ...
                <Flex direction='column'>
                    <Box sx={{ width: "50%" }}>
                        ...
                        <FormControl sx={{ minWidth: '80%', marginTop: "24px" }}>
                        ...
                        <Typography variant="h5" sx={{ marginTop: "24px", fontWeight: 700 }}>Обуна 30 кун давом этади</Typography>
                    </Box>
                    <Box>
                        <CustomBox>
                            <Flex>
                            ...
                            <Flex>
                                ...
                                <Typography variant="smallBold" sx={{ color: "#3F51B5" }}>12 000 сум</Typography>
                            </Flex>
                        </CustomBox>
                        <Button variant="contained" size="large" sx={{ width: "100%", marginTop: "24px", minHeight: "44px" }}>Обуна булиш</Button>
                    </Box>
                </Flex>
