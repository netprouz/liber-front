...
const Wallet = () => {
    ...
    return (
        <Paper sx={{ padding: '32px' }}>
            ...
            {selectedPayment ? (
                <Box sx={{ marginTop: "35px", width: "350px" }}>
                    <Input label="Сумма" placeholder="Сум" sx={{ width: "100%" }} /><br />
                    <Button variant="contained" sx={{ minHeight: "44px", marginTop: "35px" }} fullWidth>Тулдириш</Button>
                </Box>
            ) : (
                <>
                    <Button
