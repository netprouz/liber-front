...
const SmallProductCard: React.FC<SavedProps> = ({ isSavedTabs, isNotMobile }) => (
  <Grid container columnSpacing={5} flexWrap={isNotMobile ? "wrap" : "nowrap"} sx={{ width: isSavedTabs ? "300" : "auto" }}>
